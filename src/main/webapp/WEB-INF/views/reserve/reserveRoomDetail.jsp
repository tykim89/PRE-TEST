...
<script type="text/javascript" src="<c:url value='/resources/js/reserveRoomDetail.js' />" ></script>
</head>
<body>
<input type="hidden" id="msg" value=${msg }>
	...
	<div>
	<form id="rForm" >
	<input type="hidden" id="r_no" name="r_no" value="${reserveRoomVO.r_no }">
	<input type="hidden" id="res_r_room_no" name="res_r_room_no" value="${reserveRoomVO.r_room_no }">
	<input type="hidden" id="res_r_start_time" name="res_r_start_time" value="${reserveRoomVO.r_start_time }">
	<input type="hidden" id="res_r_end_time" name="res_r_end_time" value="${reserveRoomVO.r_end_time }">
		<div>
			예약자명 : <input type="text" id="r_user_name" name="r_user_name" value="${reserveRoomVO.r_user_name }">
		</div>
		<div>
		...
		<div>
			회의실 : 
			<select id="r_room_no" name="r_room_no" value="${reserveRoomVO.r_room_no }">
				<option value=""></option>
		...
		<div>
			예약일자 : <input type="text" id="picker" name="r_reserve_date" value="${reserveRoomVO.r_reserve_date }">
		</div>
		<div>
			예약시간 : 
		...
		<div>
			<input type="button" id="btn_reserve_cancel" value="예약취소">
